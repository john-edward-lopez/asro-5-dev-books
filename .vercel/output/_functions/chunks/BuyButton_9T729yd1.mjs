import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as createAstro, d as addAttribute, b as renderComponent } from './astro/server_Cu9eT8yJ.mjs';
import 'kleur/colors';
import 'clsx';
...
}, "C:/Users/john lopez/Desktop/aprendiendo-astro/src/components/AmazonLogo.astro", undefined);

const $$Astro = createAstro();
const $$BayButton = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$BayButton;
  const SPAIN = "ES";
...
const $$file = "C:/Users/john lopez/Desktop/aprendiendo-astro/src/components/BayButton.astro";
const $$url = undefined;

export { $$BayButton as default, $$file as file, $$url as url };
